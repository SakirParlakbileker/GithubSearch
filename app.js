...
function createUserCard(user) {
  // varsa user name yazdır yok ise user login name'i yazdır.
  const userName = user.name || user.login;
  // eğer bio yoksa null yazmasın, hiçbir şey yazmasın "" yaptık.
...
async function getRepos(username) {
  try {
    ...
    // console.log(err);
    createErrorCard("Üzgünüm repoşarı çekerken hata oluştu :(");
  }
}
